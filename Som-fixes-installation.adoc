...
To verify the correct installation of the Knative CLI, you can execute the following command to obtain information about
...
Executing the following command will first create a namespace called `knative-serving` and then will install the Knative Serving Custom resource in that namespace:

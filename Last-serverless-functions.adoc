...
`kn func` CLI can generate function projects from pre-defined set of templates that generate function projects from boilerplates. 
...
-----
The URL will be different based on the cluster where you are deploying the Knative function.s
